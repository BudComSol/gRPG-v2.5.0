...
SELECT * FROM (SELECT
    ...
    'images/npc/vagrant.png' AS `image`,
...
SELECT * FROM (SELECT
    ...
    'images/npc/street-thug.png' AS `image`,
...
SELECT * FROM (SELECT
    ...
    'images/npc/drug-dealer.png' AS `image`,
...
SELECT * FROM (SELECT
    ...
    'images/npc/crime-boss.png' AS `image`,
...
SELECT * FROM (SELECT
    ...
    'images/npc/gang-lieutenant.png' AS `image`,
...
SELECT * FROM (SELECT
    ...
    'images/npc/enforcer.png' AS `image`,
