...
?><tr>
    <th class="content-head">Whats This?</th>
</tr>
<tr>
    <td class="content">
        <table width="100%" cellpadding="5" cellspacing="2">
            <tr>
                ...
                <td class="center">
                    <h1 style="font-size: inherit;">Generic RPG or gRPG is a full stack game engine written in PHP</h1>
                    Welcome to Generic RPG or gRPG which is an full stack engine written in PHP that allows you to create an MMORPG style browser game of your very own. It can be themed in just about any genre, from gangster to outer space, it's limited only by you're imagination and the best part is that it is free and can be found on <a href="https://github.com/BudComSol/gRPG-v2.5.0" target="_blank" rel="noopener">Github</a> so that you may contribute.
...
<tr>
    <td class="content-home">        
        <ul>            
            ...
            <li>A wiki that explains all the aspects of the game, and is updated by GRPG players.</li>  
            <li>A casino where you can gamble your hard earned cash playing the lottery and more.</li>        
            <li>Event system to let you know when something interesting happens behind your back.</li>            
            <li>Job system where you can get a job and make money every day and not work to hard.</li>
            <li>RM Store where you buy in game items and Membership in the game using real money.</li>            
        </ul>
    </td>
</tr>
<tr>
    <th class="content-head">Check These!</th>
</tr>
<tr>
    <td class="content">
