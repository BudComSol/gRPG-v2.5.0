    ...
    <td class="content">
        <table width="100%" cellpadding="5" cellspacing="2">
            <tr>
                ...
                <td class="center">
                    <p><h1 style="font-size: inherit; display: inline;">Generic RPG or gRPG is a full stack game engine written in PHP</h1> that allows you to create an MMORPG style browser game of your very own. It can be themed in just about any genre, from gangster to outer space, it's limited only by your imagination and the best part is that <h2 style="font-size: inherit; display: inline;">it is free and can be found on <a href="https://github.com/BudComSol/gRPG-v2.5.0" target="_blank" rel="noopener">Github</a> so that you may contribute.</h2></p>
