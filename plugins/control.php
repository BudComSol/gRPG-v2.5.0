...
$nums2 = array_unique(['money', 'strength', 'defense', 'speed', 'level', 'landleft', 'landprice', 'levelreq', 'nerve', 'cost', 'offense', 'heal', 'reduce', 'itemnumber', 'itemquantity', 'rmdays', 'points', 'hookers', 'crimeid', 'cityid', 'jobid', 'id', 'board', 'forum', 'forum2', 'recycle', 'delete', 'awake', 'buyable', 'basemod', 'bank', 'experience', 'hp', 'energy', 'admin_lvl']);
