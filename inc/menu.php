...
<div>
    ...
    <a class="leftmenu" href="plugins/todo.php"><?php echo $owner->username; ?>'s To-Do List</a>
    <a class="leftmenu" href="plugins/forum.php">Forum</a>
    <a class="leftmenu" href="plugins/classifieds.php">Classified Ads</a>
    ...
    <a class="leftmenu" href="plugins/gym.php">Gym</a>
    ...
    <a class="leftmenu" href="plugins/rmstore.php">RM Store</a><?php
    if ($user_class->admin == 1) {
        ?>
        <div class="headbox" style="color:yellow;">Staff</div>
        <a class="leftmenu" href="plugins/control.php">Staff Panel</a><?php
    } ?>
...
?><a class="leftmenu" href="index.php?logout">Logout</a>
    <a class="leftmenu" href="plugins/preferences.php">Change Preferences</a>
